        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.textContainer}>
           ...
           
           {
            ...
            <Text style={styles.title}>{`Article Title: ${item?.article?.title}`}</Text>
  
            <Text style={styles.title}>{`Request Reason: `}</Text>
            <Text style={styles.description}>{`${item?.edit_reason.length <= 100? item?.edit_reason: item?.edit_reason.substring(0, 100)}...`}</Text>
